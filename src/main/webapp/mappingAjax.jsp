	...
	if(command != null) {
		if(command.equals("init")) {
			...
			if(input != null && output != null && mapping != null) {
				//System.out.println(input + " " + mapping + " " + output);
//				String inputPath = this.getServletContext().getRealPath(input);
//				String outputPath = this.getServletContext().getRealPath(output);
				String inputPath = xml_rep_path + input;
				String outputPath = xml_rep_path + output;
                            
//				mappings.setFilePath(path);

				mappings.init(inputPath,inputType, mapping, outputPath, outputType);
